...
static cudnn_frontend::Tensor createMask(
    ...
    std::vector<cudnn_frontend::Operation> &ops,
    cudnn_frontend::Tensor &prevBlockOutputTensor, bool is_bprop) {
...
void run_mha_fprop(int64_t b, int64_t h, int64_t s_q, int64_t s_kv, int64_t d,
...
void run_mha_bprop(int64_t b, int64_t h, int64_t s_q, int64_t s_kv, int64_t d,
